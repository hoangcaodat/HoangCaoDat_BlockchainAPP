...
public class HoangDat_Chain {
    ...
    public static HCDWallet walletA; //Ví A
    public static HCDWallet walletB; //Ví B
    ...
    public static void main(String[] args) {
        ...
        //Tạo ra các ví
        walletA = new HCDWallet();
        walletB = new HCDWallet();
        HCDWallet coinbase = new HCDWallet();
